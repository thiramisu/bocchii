  ...
  class トップ extends 画面 {
    ...
    新規登録完了表示(名前, パスワード, 職業名, 性別, ステータス) {
      for (const [ID, 値] of new Map([
        ...
        ["新規登録完了-職業", 職業名],
        ["新規登録完了-性別", 性別],
        ["新規登録完了-ＨＰ", ステータス.ＨＰ.基礎値],
        ["新規登録完了-ＭＰ", ステータス.ＭＰ.基礎値],
        ["新規登録完了-攻撃力", ステータス.攻撃力.基礎値],
        ["新規登録完了-守備力", ステータス.守備力.基礎値],
        ["新規登録完了-素早さ", ステータス.素早さ.基礎値]
      ])) {
        $id(ID).textContent = 値;
      }
